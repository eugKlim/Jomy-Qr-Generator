...
const AllQrPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>История QR-кодов - Jomy QR Generator</title>
        <meta
          name="description"
          content="Просматривайте историю сгенерированных QR-кодов в Jomy QR Generator. Сохраняйте и используйте свои QR-коды в любое время."
        />
        <meta
          name="keywords"
          content="история QR-кодов, сохраненные QR-коды, генератор QR-кодов, qr code history, qr generator history"
        />
      ...
      <div className="bg-dark pt-20 md:px-20 pb-40">
        <div className="mb-10 px-8">
          ...
          <p className="text-lg mt-5 mb-10 leading-8">
            Сохраняйте и просматривайте все QR-коды, которые вы создавали в Jomy
            QR Generator. Удобный доступ к вашим QR-кодам в любое время!
          </p>
          <span className="w-14 h-1 bg-red-600 inline-block" />
        </div>
